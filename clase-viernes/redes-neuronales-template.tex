...
\graphicspath{{redes-neuronales.assets}}
...
\begin{document}
  ...
  \begin{thebibliography}{8}
    \bibitem{savagenotes} Savage, Jesús. \textit{Redes neuronales} en
    \url{https://biorobotics.fi-p.unam.mx/wp-content/uploads/Courses/
